...
* b) ASCII representation of the tree (more complicated, more fun)
  ...
  public Integer peekMax()
  {
    ...
    /* Algorithm for adding:
       ...
       2) If the element that was added is greater than its parent, swap the parent with the added element. If not, STOP.
  ...
  public void add( Integer addVal )
  {
    ...
    /* Algorithm for removing:
       ...
       2) If the new root is less than the least child, swap. If not, STOP.
       3) Repeat step 2 for every swap made until the element is in correct pos
	   */
  /*****************************************************
  ...
  public Integer removeMax()
  {
      ...
      Integer retInt = peekMax();//needs to be returned
	...
	while( pos < _heap.size() ) {
	    ...
	    else if ( newRoot <=  _heap.get(maxChild) ){
		swap( pos, maxChild );
		pos = maxChild;
	    }
